...
kable(bal_df, "pipe", caption = "Summary of Covariate Balance Post-Matching For Unfunded Control Group") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
# Display the cleaned-up table with kable
kable(bal_df_funded, "pipe", caption = "Summary of Covariate Balance Post-Matching For Funded Control Group") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
The three-way interaction among treatment, independence_timing, and field was not statistically significant. This implies that the interaction effect of treatment and independence_timing on independence remained consistent across different disciplines.
...
kable(cor_matrix, format = "html", digits = 2, caption = "Correlation Matrix of RII indicator and its sub-parts") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
The results of this study provide important insights into the effects of funding interventions on researcher independence. We did not find a significant intervention effect of funding programmes for early career researchers, compared to no funding or other types of grant funding. These results suggest funding might not be an important factor in developing researcher independence. This is surprising finding, since many people have voiced worries about funding having strong effect either by making junior researchers more cautious and risk-averse in order to fulfill the grant conditions, limiting the novelty of their work; or by giving them more protected space where they can freely experiment and step off the traditional paths, opening new lines of research. Neither of these theories are supported by our findings. Instead, there are likely other factors influencing development of research independence more significantly.

The strongest effect we found across all control group comparisons was the effect of time: over time, researchers become more independent, regardless of their access to funding or their study discipline. This effect explains around 60% of the variance in independence.

Additionally, the observed variation in independence across different disciplines underscores the importance of considering disciplinary differences, suggested by a moderate effect size. A moderate effect size for the field effect emphasizes that certain disciplines might inherently have variations in researchers' independence, but this is driven mostly by collaboration patterns rather than cognitive patterns (e.g. differences in practices, methodologies, or norms specific to each discipline). These differences remain constant across time and funding interventions, suggesting that funding has a uniform effect on the independence across disciplines.
...
Given that funding for early career researchers does not have effect on stimulating their cognitive independence, does it make sense to continue providing it? While funding itself might not be the main driver of cognitive independence, it might still play an important role. For example, it could be a necessary, though not sufficient, condition for the development of independence. From a common sense view, it is hard to imagine that researchers can develop much of independence while only working on someone else's (often their advisor's) projects. In any case, our results suggest that the search for factors and interventions stimulating researchers' exploratory behaviours should continue.       


Main value of this paper is manyfold. It investigated one potential factor (funding) hypothesized to stimulate researcher independence, rendering this factor unimportant, contrary to expectations, Further, it confirmed there are meaningful differences in level of independence across disciplines and has illuminated the magnitude of cognitive independence experienced by researchers early in their careers, including its development to later stages. This contributes to the discussions about tradition and innovation in research topic choice strategies and recreating status quo in science.
...
Our results showed that funding does not help to stimulate independence of early career researchers. The largest effect on increase in independence was time: over time, researchers become more independent, regardless of their access to funding or their study discipline. There were also significant differences in independence level across study disciplines, where social sciences and humanities allowed for more independence than other disciplines. Researchers usually start with around 40 % of topics not shared by their PhD advisor early on after finishing their PhD and grow more independent over time (up to 47 % of independent topics 14 years after their first publication). Search for factors and interventions stimulating researchers' cognitive independence and exploratory behaviour should thus continue.
