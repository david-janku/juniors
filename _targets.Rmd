...
list(
  ...
  tarchetypes::tar_download(riv_authors_path,
   ...
   tarchetypes::tar_download(sup_path,
      urls = Sys.getenv("link_to_supervisors_control"),
      paths = here::here("data", "raw", "supervisors_control_final.csv")),
     ...
     tar_target(db_path, here::here("data", "raw", "czech_sci_db.sqlite")),
...
list(
      ...
      tar_target(matching_data, match_data_prep(db_path, ids, gender, authors_arrow, cep_investigators_arrow, cep_details_arrow, riv_details_arrow, riv_authors_arrow)),
      tar_target(matched_obj_unfunded, match_obj_unfunded(matching_data)), 
      tar_target(matched_obj_funded, match_obj_funded(db_path, authors_arrow, matching_data)),
     ...
     #          format = "qs"),
      tar_target(final_data, refine_data(matching, db_path, ids_complete, sup_control, authors_arrow)),
