...
list(
 ...
 #              format = "qs"),
    ...
    tar_target(ids_complete_vector,
               make_ids_complete_vector(ids)),
    tar_target(db_path,
           here::here("data", "raw", "czech_sci_db.sqlite")),
    tar_target(all_pubs,
           get_all_pubs(db_path, ids), 
              format = "qs"),
    tar_target(one_author,
           read_one_author(db_path, ids_complete_vector), 
...
list(
    ...
    tar_target(final_data,
               calc_final_data(eigen_centr, clustering = NULL, ind_topics = NULL, ind_pubs = NULL),
               format = "qs")
