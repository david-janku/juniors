...
list(
     ...
     # tar_target(sup_path, here::here("data", "raw", "manual_sup_search.csv"), format = "file"),
      tar_target(sup_control, read.csv2(sup_path)),
     
      tar_target(matching_data, match_data_prep(db_path, ids, gender, sup_control)),
      ...
      tar_target(matching, match_data(matched_obj_unfunded, matched_obj_funded)),
       ...
       # tar_target(sup_path_second, here::here("data", "raw", "manual_sup_search_second.csv"), format = "file"),
      tar_target(sup_control_second, read.csv2(sup_path_second)),
