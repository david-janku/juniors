...
desc_0 <- df %>%
  filter(treatment == 0) %>%
  summarise(across(all_of(numeric_vars), list(mean = mean, sd = sd, min = min, max = max)))
...
# Now you can print these as tables in your Rmd document

# Print table for treatment level 0
kable(desc_0, caption = "Descriptive statistics for treatment level 0")

# Print table for treatment level 1
kable(desc_1, caption = "Descriptive statistics for treatment level 1")

# Print table for treatment level 2
kable(desc_2, caption = "Descriptive statistics for treatment level 2")
