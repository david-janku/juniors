...
unf_sum <- summary(matched_obj_unfunded, un = FALSE)

summary(matched_obj_unfunded)
    
plot(unf_sum, var.order = "unmatched")


cobalt::bal.tab(matched_obj_unfunded, un = FALSE, stats = c("m", "v", "ks"), binary = "std")

cobalt::love.plot(matched_obj_unfunded, binary = "std", var.order = "unmatched")





fun_sum <- summary(matched_obj_funded, un = FALSE)

summary(matched_obj_funded)
